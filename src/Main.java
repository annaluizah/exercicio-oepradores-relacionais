public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("s1 != s2" + (s1 != s2));
        //não é lógico comparar -> System.out.println(s1 >= s2);
        //não é lógico comparar -> System.out.println(s1 < s2);

        System.out.println("b1 == b2 " + (b1 == b2));
        System.out.println("b1 != b2 " + (b1 != b2));
        //não é lógico comparar -> System.out.println(b1 > b2);
        //não é lógico comparar -> System.out.println(b1 <= i1);

        System.out.println("i2 > f1 " + (i2 > f1));
        System.out.println("d1 == h1 " + (d1 == h1));
        //não é lógico comparar -> System.out.println(s2 != c1);
        //não é lógico comparar -> System.out.println(s3 != i1);
